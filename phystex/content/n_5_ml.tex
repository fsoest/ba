...
This allows us to freely choose the dimensionality of the hidden and cell state, which would be limited to the embedding size of 4 (Eq. (\ref{embedding})) if we only used LSTM cells.
