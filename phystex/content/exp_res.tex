...
To quantify dissimilarity between the training data and model predictions as well as to update the trainable parameters a differentiable cost function is needed.
