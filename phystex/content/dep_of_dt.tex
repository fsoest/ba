...
For smaller $\Delta \mathrm{T}$, the work per extraction step is lower. In these cases the optimal system state cannot be reached due to the speed limit in unitary dynamics \cite{Deffner_2017, PhysRevA.67.052109}.
