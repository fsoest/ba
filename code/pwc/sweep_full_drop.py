...
if __name__ == '__main__':
    ...
    epoch, vloss, vwork = train_lstm(opt_args['dropout'], opt_args['learning_rate'],opt_args['patience'], opt_args['batch_size'], opt_args['n_layers'], opt_args['bidirectional'], opt_args['hidden_size'], opt_args['hidden_input_1'], opt_args['hidden_input_2'], opt_args['hidden_output'], 'sgd', opt_args['pat_drop'], opt_args['sched_factor'], N, dt, N_sobol, rho, runs, net)
