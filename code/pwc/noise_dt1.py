...
leg = plt.legend(title='$\\tau$', fontsize=10)
for lh in leg.legendHandles:
    lh.set_alpha(1)
plt.xlabel('$\overline{F}_D$', fontsize=15)
plt.xlim(0.4, 1.01)
...
# %%
np.save('noise/noisy_work_drive2dt1', noisy_work_drive)
np.save('noise/work_drive2dt1', work_drive)
np.save('noise/avg_fidel_drive2dt1', avg_fidel_drive)

np.save('noise/noisy_work_trans2dt1', noisy_work_trans)
np.save('noise/work_trans2dt1', work_trans)
np.save('noise/avg_fidel_trans2dt1', avg_fidel_trans)
# %%
